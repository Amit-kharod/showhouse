...
import ShowFormPopup from "./components/ShowFormPopup";
...
function App() {
  ...
  return (
    <div className="app">
      ...
      <Shows filters={filters} showsData={showsData} setIsShowFormOpen={setIsShowFormOpen} />
      {isShowFormOpen && (
        <ShowFormPopup
          showsData={showsData}
          setShowsData={setShowsData}
          setIsShowFormOpen={setIsShowFormOpen}
        />
      )}
    </div>
  );
